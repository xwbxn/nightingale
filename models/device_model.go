...
type DeviceModel struct {
	...
	ProducerId         int64   `gorm:"column:PRODUCER_ID" json:"producer_id" cn:"厂商" source:"type=table,table=device_producer,field=alias" ` //type:*int       comment:厂商-ID;来源设备厂商信息   version:2023-07-08 14:55
