...
type DeviceCabinet struct {
	...
	BelongRoom             int64   `gorm:"column:BELONG_ROOM" json:"belong_room" cn:"所在机房" source:"type=table,table=computer_room,field=room_name"`                   //type:string     comment:所在机房                                        version:2023-07-11 15:14
	...
	ProducerId             int64   `gorm:"column:PRODUCER_ID" json:"producer_id" cn:"厂商" source:"type=table,table=device_producer,field=alias"`                       //type:string     comment:厂商                                            version:2023-07-11 15:14
	CabinetModel           int64   `gorm:"column:CABINET_MODEL" json:"cabinet_model" cn:"型号" source:"type=table,table=device_model,field=model"`                      //type:string     comment:型号                                            version:2023-07-11 15:14
