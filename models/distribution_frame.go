...
type DistributionFrame struct {
	...
	RoomId          int64          `gorm:"column:ROOM_ID" json:"room_id" cn:"所属机房" validate:"required" source:"type=table,table=computer_room,property=id,field=room_name"`             //type:*int     comment:所属机房                             version:2023-07-25 17:23
	CabinetId       int64          `gorm:"column:CABINET_ID" json:"cabinet_id" cn:"机柜编号" validate:"required" source:"type=table,table=device_cabinet,property=id,field=cabinet_code"`   //type:*int     comment:所属机柜                             version:2023-07-29 15:08
	DisFrameCode    string         `gorm:"column:DIS_FRAME_CODE" json:"dis_frame_code" cn:"配线架编号" validate:"required"`                                                                  //type:string   comment:配线架编号                           version:2023-9-10 16:34
	DisName         string         `gorm:"column:DIS_NAME" json:"dis_name" cn:"配线架名称"`                                                                                                  //type:string   comment:配线架名称    version:2023-07-16 10:14
	ProducerId      int64          `gorm:"column:PRODUCER_ID" json:"producer_id" cn:"厂商" source:"type=table,table=device_producer,property=id;producer_type,field=alias,val=producer" ` //type:*int     comment:厂商                                 version:2023-07-25 17:25
	Model           int64          `gorm:"column:MODEL" json:"model" cn:"型号" source:"type=table,table=device_model,property=id,field=model" `                                           //type:string   comment:型号          version:2023-07-16 10:14
	...
	PurchaseAt      int64          `gorm:"column:PURCHASE_AT" json:"purchase_at" cn:"采购日期" source:"type=date,value=2006-01-02 15:04:05"`                                                //type:*int     comment:采购日期      version:2023-07-16 10:14
