...
type Pdu struct {
	...
	Brand         string  `gorm:"column:BRAND" json:"brand" cn:"品牌"`                                                               //type:string     comment:品牌                  version:2023-07-16 10:13
	Model         string  `gorm:"column:MODEL" json:"model" cn:"型号"`                                                               //type:string     comment:型号                  version:2023-07-16 10:13
	...
	EquipmentRoom string  `gorm:"column:EQUIPMENT_ROOM" json:"equipment_room" cn:"所在机房" validate:"required"`                       //type:string     comment:所在机房              version:2023-07-16 10:13
	CabinetCode   string  `gorm:"column:CABINET_CODE" json:"cabinet_code" cn:"所在机柜编号" validate:"required"`                         //type:string     comment:所在机柜编号          version:2023-07-16 10:13
