...
type Pdu struct {
	...
	Brand         int64   `gorm:"column:BRAND" json:"brand" cn:"品牌" source:"type=table,table=device_producer,field=alias"`                                         //type:string     comment:品牌                  version:2023-07-16 10:13
	Model         int64   `gorm:"column:MODEL" json:"model" cn:"型号" source:"type=table,table=device_model,field=model"`                                            //type:string     comment:型号                  version:2023-07-16 10:13
	...
	PurchaseAt    int64   `gorm:"column:PURCHASE_AT" json:"purchase_at" cn:"采购日期" source:"type=date,value=2006-01-02"`                                             //type:*int       comment:采购日期              version:2023-07-16 10:13
	...
	BelongRoom    int64   `gorm:"column:BELONG_ROOM" json:"belong_room" cn:"所在机房" validate:"required" source:"type=table,table=computer_room,field=room_name"`     //type:*int       comment:所在机房                 version:2023-07-29 15:22
	CabinetId     int64   `gorm:"column:CABINET_ID" json:"cabinet_id" cn:"所在机柜编号" validate:"required" source:"type=table,table=device_cabinet,field=cabinet_code"` //type:*int       comment:所在机柜编号             version:2023-07-29 15:22
