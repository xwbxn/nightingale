...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/n9e/alert-events/export-xls": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.ApiService"
                            }
                        }
                    }
                }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/router.apiServiceFE"
                            }
                        }
                    }
                }
        ...
        "/api/n9e/api-service/{id}/execute": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.LogoConfig"
                            }
                        }
                    }
                }
    ...
    "definitions": {
        ...
        "models.ApiService": {
            ...
            "properties": {
                "datasource_id": {
                    "description": "type:*int     comment:数据源;promql 需要指定数据源   version:2023-10-20 16:47",
                    "type": "integer"
                },
                "deleted_at": {
                    "description": "type:*int     comment:删除时间                       version:2023-10-20 16:47",
                    "type": "integer"
                },
                "id": {
                    "description": "type:*int     comment:主键                           version:2023-10-20 16:47",
                    "type": "integer"
                },
                "name": {
                    "type": "string"
        ...
        "models.Bigscreen": {
            ...
            "properties": {
                ...
                "deleted_at": {
                    "description": "type:*int     comment:删除时间    version:2023-10-21 10:37",
                    "type": "integer"
                },
                "desc": {
                    "type": "string"
                ...
                "id": {
                    "description": "type:*int     comment:主键        version:2023-10-21 10:37",
                    "type": "integer"
                },
                "title": {
                    "type": "string"
        ...
        "models.UserConfig": {
            ...
            "properties": {
                "access_expired": {
                    "description": "type:*int         comment:token有效期（用户登录）    version:2023-10-13 10:09",
                    "type": "integer"
                },
                "api_service": {
                    "description": "type:*int         comment:APIForService              version:2023-10-13 10:09",
                    "type": "integer"
                },
                "captcha": {
                    "description": "type:*int         comment:启用验证码                 version:2023-10-13 10:09",
                    "type": "integer"
                },
                "http_host": {
                    "type": "string"
                ...
                "http_port": {
                    "description": "type:*int         comment:HTTP监听端口               version:2023-10-13 10:09",
                    "type": "integer"
                },
                "id": {
                    "description": "type:BIGINT       comment:配置主键                   version:2023-10-13 10:09",
                    "type": "integer"
                },
                "log_lever": {
                    "description": "type:*int         comment:日志等级                   version:2023-10-13 10:09",
                    "type": "integer"
                },
                "login_title": {
                    "type": "string"
                ...
                "open_rsa": {
                    "description": "type:*int         comment:启用加密                   version:2023-10-13 10:09",
                    "type": "integer"
                },
                "refresh_expired": {
                    "description": "type:*int         comment:token有效期（长期展示）    version:2023-10-13 10:09",
                    "type": "integer"
                }
            }
        },
